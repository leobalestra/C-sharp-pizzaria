...
{
    public partial class PaginaRelatorio4 : Form
    {
        public PaginaRelatorio4()
        {
            InitializeComponent();
        }
        ...
        {
            // TODO: esta linha de código carrega dados na tabela 'projetoPizzariaDataSet9.tblPedido'. Você pode movê-la ou removê-la conforme necessário.
            this.tblPedidoTableAdapter.Fill(this.projetoPizzariaDataSet9.tblPedido);
        }
        ...
        {
            PaginaRelatorio4.ActiveForm.Close();
        }
