...
{
    public partial class PaginaRelatorio5 : Form
    {
        public PaginaRelatorio5()
        {
            InitializeComponent();
        }
        ...
        {
            // TODO: esta linha de código carrega dados na tabela 'projetoPizzariaDataSet10.tblCliente'. Você pode movê-la ou removê-la conforme necessário.
            this.tblClienteTableAdapter.Fill(this.projetoPizzariaDataSet10.tblCliente);
        }
        ...
        {
            PaginaRelatorio5.ActiveForm.Close();
        }
